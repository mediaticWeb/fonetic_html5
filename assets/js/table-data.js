var TableData = function() {
	...
	var runDataTable_example2 = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[2].innerHTML = '<a class="save-row" href="">Guardar</a>';
			jqTds[3].innerHTML = '<a class="cancel-row" href="">Cancelar</a>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit-row" href="">Editar</a>', nRow, 2, false);
			oTable.fnUpdate('<a class="delete-row" href="">Borrar</a>', nRow, 3, false);
			oTable.fnDraw();
			newRow = false;
		...
		$('#sample_2').on('click', '.delete-row', function(e) {
			...
			bootbox.confirm("Are you sure to delete this row?", function(result) {
				if (result) {
					$.blockUI({
					message : '<i class="fa fa-spinner fa-spin"></i> Borrando usuario...'
					});
					$.mockjax({
		...
		$('#sample_2').on('click', '.save-row', function(e) {
			...
			var nRow = $(this).parents('tr')[0];
			$.blockUI({
					message : '<i class="fa fa-spinner fa-spin"></i> Guardando usuario...'
					});
					$.mockjax({
